  ...
  return async function (fastify: FastifyInstance) {
    ...
    fastify.post('/tenants', async (req, reply) => {
      ...
      return reply.code(201).send({
        ...
        data: {
          ...
          tempPassword: wasAutoGenerated && !emailSent ? tempPassword : undefined,
          emailSent,
          adminEmail: body.adminEmail,
        },
      });
    ...
    fastify.post('/users/:uid/regenerate-password', async (req, reply) => {
      ...
      return reply.send({
        ...
        data: { tempPassword: emailSent ? null : newPassword, emailSent, email: u.email },
      });
    });
    ...
    fastify.post('/users/:uid/send-reset-email', async (req, reply) => {
      ...
      return reply.send({ success: true, data: { emailSent, email: u.email } });
    });
